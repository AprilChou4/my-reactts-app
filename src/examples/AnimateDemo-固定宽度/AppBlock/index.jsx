...
// }
const AppBlock = ({ className, animateBg, style, titleProps }) => {
  const imgProps = {
    unitWidth: 100,
    unitHeight: 100,
    imgCount: 50,
  ...
  return (
    <div className={`appBlock ${className || ""}`} style={style}>
      <div
        ...
        style={{
          backgroundImage: `url(${titleBg || indicatorTitle})`,
          ...titleStyle,
        }}
        {...titleRest}
      ></div>
      <AnimateImg bgImage={animateBg} {...imgProps} />
      <div
        className="appBlockFoot"
        style={{ backgroundImage: `url(${blockFoot})` }}
      ></div>
    </div>
  );
};
